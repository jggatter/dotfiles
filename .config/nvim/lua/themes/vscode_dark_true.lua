...
M.polish_hl = {
  treesitter = {
		Boolean = { fg = M.base_30.teal },
		["@constant"] = { fg = M.base_30.nord_blue },
		["@constant.builtin"] = { fg = M.base_30.teal  }, -- None
    ...
    ["@constructor"] = { fg = M.base_30.green1 }, -- Class invocation
		Type = { fg = M.base_30.green1 }, -- Classes
    ["@type.builtin"] = { fg = M.base_30.green1 }, -- str
    Include = { fg = M.base_16.base0E }, -- from import
    ["@keyword.repeat"] = { fg = M.base_16.base0E }, -- for
    ["@keyword.return"] = { fg = M.base_16.base0E },
    Special = { fg = M.base_16.base0E }, -- f-string braces
  },
}
